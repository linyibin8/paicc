...
def archive_app(release_dir: Path, env: dict[str, str]) -> Path:
    ...
    run(
        [
            ...
            f"CODE_SIGN_IDENTITY={env.get('CODE_SIGN_IDENTITY', 'Apple Distribution: Shenzhen Youdezhe Technology Co., Ltd. (N3G45G5H74)')}",
            f"PROVISIONING_PROFILE_SPECIFIER={env.get('PROVISIONING_PROFILE_SPECIFIER', '')}",
